...
public class JuegoService {
	...
	public List<Juego> getByNombre(String nombre){
		return this.juegoCrudRepository.findByNombreContaining(nombre);
	}
	
	public List<Juego> getByPlataforma(String plataforma){
		return this.juegoCrudRepository.findByPlataformaContaining(plataforma);
	}
	...
	public List<Juego> getDlcs(){
		return this.juegoCrudRepository.findByTipo(Tipo.DLC);
	}
	
	public List<Juego> getBases(){
		return this.juegoCrudRepository.findByTipo(Tipo.BASE);
	}
	...
	public List<Juego> getByMas1000Descargas(){
		return this.juegoCrudRepository.findByDescargasGreaterThanEqual(1000);
	}
